...
I just enjoy it. But each year there are the same non-value-adding steps I take:
 ...
 - write boilerplate code for reading input and passing it into a `solve` function
...
solving he actual need. So, let's automate them. 
...
## Considerations
 ...
 - RATE LIMIT - Eric is a legend for setting AoC up every year, respect his infra and costs. <3 
